...
export const metadata: Metadata = {
  title: "Gaurav Kumar | ARtoRiAs10",
  description:
    "Gaurav Kumar (ARtoRiAs10) is a Full Stack Developer and AI/ML enthusiast from India, skilled in Next.js, React, TypeScript, Python, and machine learning. Building innovative web apps and AI-powered solutions.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
